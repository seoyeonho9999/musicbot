...
\nm도움말 -> 뮤직봇의 모든 명령어를 볼 수 있습니다.
\nm들어와 -> 뮤직봇을 자신이 속한 채널로 부릅니다.
\nm나가 -> 뮤직봇을 자신이 속한 채널에서 내보냅니다.
\nmURL재생 [노래링크] -> 유튜브URL를 입력하면 뮤직봇이 노래를 틀어줍니다.
(목록재생에서는 사용할 수 없습니다.)
\nm재생 [노래이름] -> 뮤직봇이 노래를 검색해 틀어줍니다.
\nm노래끄기 -> 현재 재생중인 노래를 끕니다.
m일시정지 -> 현재 재생중인 노래를 일시정지시킵니다.
m다시재생 -> 일시정지시킨 노래를 다시 재생합니다.
\nm지금노래 -> 지금 재생되고 있는 노래의 제목을 알려줍니다.
\nm멜론차트 -> 최신 멜론차트를 재생합니다.
\nm즐겨찾기 -> 자신의 즐겨찾기 리스트를 보여줍니다.
m즐겨찾기추가 [노래이름] -> 뮤직봇이 노래를 검색해 즐겨찾기에 추가합니다.
m즐겨찾기삭제 [숫자] ->자신의 즐겨찾기에서 숫자에 해당하는 노래를 지웁니다.
\nm목록 -> 이어서 재생할 노래목록을 보여줍니다.
m목록재생 -> 목록에 추가된 노래를 재생합니다.
m목록초기화 -> 목록에 추가된 모든 노래를 지웁니다.
\nm대기열추가 [노래] -> 노래를 대기열에 추가합니다.
m대기열삭제 [숫자] -> 대기열에서 입력한 숫자에 해당하는 노래를 지웁니다.""", color = 0x00ff00))
